...
async function loadAllHotelRoom() {
...
async function loadARoom() {
    ...
    if (id != null) {
        ...
        await loadAllHotelRoom();
        document.getElementById("listdpar").value =result.hotel.id
...
async function saveRoom() {
    ...
    var hotel = document.getElementById("listdpar").value
